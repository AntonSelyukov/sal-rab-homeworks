function calcShipping(sum, min, shipping) {
    ...
    else shippingSum = shippingPrice; // если productsSum больше 0 и меньше freeShippingMinSum,
...
function calcDiscount(sum, min, discount) {
    ...
    let discountSum = productsSum >= discountMinSum ? discountPart * productsSum / 100 : 0; // создайте переменную discountSum
